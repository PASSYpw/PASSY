...
if ($action != "misc/export") header("Content-Type: application/json; charset=UTF-8");
    ...
    if ($userManager->isAuthenticated()) {
        ...
        switch ($action) {
            ...
            case "misc/import":
                ...
                $result = $passwords->queryImport(file_get_contents($content), $userManager->getUserID(), $userManager->getMasterPassword());
                die($result->getJSONResponse());
                break;
            ...
            case "misc/export":
                ...
                header('Content-Length: ' . \Scrumplex\PASSY\Util::getSize($result));

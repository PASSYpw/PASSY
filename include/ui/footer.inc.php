...
<div class="footer">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 569.2 952.76" width="50px" height="50px" onclick="location.reload(true); return false">
                    ...
                    <text transform="translate(0 901.39)"
                          style="font-size:189.54827880859375px;font-family:Roboto-Regular, Roboto,serif;letter-spacing:-0.06738110594582167em">
                        P
                        <tspan x="106.81" y="0" style="letter-spacing:-0.0000025760257654097058em">ASSY</tspan>
                    </text>
                </svg>
                <p class="text-muted">
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                ...
                <span class="hidden-xs">Version <?php echo $global["passy"]["version"] ?></span>
            </div>

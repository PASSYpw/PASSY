...
function getMYSQL()
{
    ...
    if (!($conn->query("CREATE TABLE IF NOT EXISTS `passwords` (`ID` VARCHAR(18) NOT NULL, `USERID` VARCHAR(18) NOT NULL, `USERNAME` VARCHAR(64), `PASSWORD` VARCHAR(512) NOT NULL, `WEBSITE` VARCHAR(64), `DATE` VARCHAR(12) NOT NULL, `ARCHIVED` TINYINT(1)) ENGINE=InnoDB DEFAULT CHARSET=utf8;")))
        die("database_error");
